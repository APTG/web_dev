import{$ as e,C as t,Dt as n,F as r,K as i,L as a,Mt as o,N as s,O as c,Ot as l,Z as u,it as d,nt as f,ot as p,p as m}from"../chunks/enXqZFEr.js";import"../chunks/xihTtKlq.js";import"../chunks/CpQoJEi9.js";var h=o({prerender:()=>!0}),g=a(`<li class="flex flex-col gap-0.5 sm:flex-row sm:gap-3"><a target="_blank" rel="noopener noreferrer" class="min-w-max font-medium underline hover:no-underline"> </a> <span class="text-muted-foreground"> </span></li>`),_=a(`<div class="space-y-8"><h1 class="text-3xl font-bold">Technical Reference</h1> <section class="prose max-w-none"><h2>Developer resources</h2> <p>The project's design documents, specs, and logs live in the repository under <code>docs/</code>.</p> <ul class="not-prose space-y-3"></ul></section> <section class="prose max-w-none"><h2>Running E2E tests locally</h2> <p>Playwright serves the built app with <code>pnpm preview</code>, so build first:</p> <pre class="overflow-x-auto rounded-lg border bg-muted p-4 text-sm"><code>pnpm build
...
digits       = 1*DIGIT`,l(S),n(14),l(x),l(v),r(a,v)}export{v as component,h as universal};
//# sourceMappingURL=5.DCXXC8Gj.js.map