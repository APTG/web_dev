import{C as e,I as t,N as n,Nt as r,O as i,Ot as a,Q as o,R as s,at as c,ct as l,et as u,kt as d,p as f,q as p,rt as m,st as h}from"../chunks/T8H6wGa2.js";import"../chunks/xihTtKlq.js";import"../chunks/DU8a7j3E.js";var g=r({prerender:()=>!0}),_=s(`<li class="flex flex-col gap-0.5 sm:flex-row sm:gap-3"><a target="_blank" rel="noopener noreferrer" class="min-w-max font-medium underline hover:no-underline"> </a> <span class="text-muted-foreground"> </span></li>`),v=s(`<div class="space-y-8"><h1 class="text-3xl font-bold">Technical Reference</h1> <section class="prose max-w-none"><h2>Developer resources</h2> <p>The project's design documents, specs, and logs live in the repository under <code>docs/</code>.</p> <ul class="not-prose space-y-3"></ul></section> <section class="prose max-w-none"><h2>Running E2E tests locally</h2> <p>Playwright serves the built app with <code>pnpm preview</code>, so build first:</p> <pre class="overflow-x-auto rounded-lg border bg-muted p-4 text-sm"><code>pnpm build
...
Expected an energy unit such as keV, MeV, or MeV/u.</code></pre> <p>Fatal errors (an unreadable link) block the calculation and offer "load defaults"; warnings
      ...
      dropped silently.</p> <p class="text-sm text-muted-foreground">Normative definition (full grammar, semantic rules, conformance vectors): <a href="https://github.com/APTG/dedx_web/blob/master/docs/04-feature-specs/shareable-urls-formal.md" target="_blank" rel="noreferrer" class="underline hover:no-underline">shareable-urls-formal.md</a>.</p></section></div>`);function y(r){let s=`https://github.com/APTG/dedx_web/blob/master`,g=[{title:`Redesign plan`,href:`${s}/docs/00-redesign-plan.md`,description:`Stage-by-stage implementation plan and current status`},{title:`Project vision`,href:`${s}/docs/01-project-vision.md`,description:`Target audience, core use cases, design principles`},{title:`Feature specs`,href:`https://github.com/APTG/dedx_web/tree/master/docs/04-feature-specs/`,description:`Per-feature specs with acceptance criteria`},{title:`WASM API contract`,href:`${s}/docs/06-wasm-api-contract.md`,description:`TypeScript ↔ libdedx interface`},{title:`Testing strategy`,href:`${s}/docs/07-testing-strategy.md`,description:`Vitest unit tests, Playwright E2E, WASM mocking`},{title:`Deployment`,href:`${s}/docs/08-deployment.md`,description:`GitHub Pages pipeline and CI`},{title:`AI changelog`,href:`${s}/CHANGELOG-AI.md`,description:`Log of all AI-assisted development sessions`}];var y=v();e(`s4a66o`,e=>{o(()=>{m.title=`Technical Reference - webdedx`})});var b=l(c(y),2),x=l(c(b),4);i(x,5,()=>g,e=>e.href,(e,r)=>{var i=_(),a=c(i),o=h(a,!0),s=l(a,2),m=h(s,!0);d(i),u(()=>{f(a,`href`,p(r).href),n(o,p(r).title),n(m,p(r).description)}),t(e,i)}),d(x),d(b);var S=l(b,6),C=l(c(S),6),w=c(C);w.textContent=`query        = [pair *("&" [pair])]
...
digits       = 1*DIGIT`,d(C),a(14),d(S),d(y),t(r,y)}export{y as component,g as universal};
//# sourceMappingURL=5.B9pcCmKw.js.map