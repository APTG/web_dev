import{C as e,Dt as t,Et as n,F as r,L as i,Z as a,it as o,jt as s,nt as c,ot as l}from"../chunks/DO1BZ5PE.js";import"../chunks/xihTtKlq.js";import"../chunks/8A1its6A.js";var u=s({prerender:()=>!0}),d=i(`<div class="space-y-8"><h1 class="text-3xl font-bold">Technical Reference</h1> <section class="prose max-w-none"><h2>Shareable URL contract</h2> <p>Every calculator and plot view is fully described by its query string, so a URL can be copied,
      ...
      a <a href="https://peggyjs.org/" target="_blank" rel="noreferrer" class="underline">Peggy</a> parser that produces an abstract syntax tree. The current schema is <strong>v2</strong> (<code>urlv=2</code>); links using the retired v1 format are no longer parsed and instead show
      an "unsupported link" notice with a one-click "load defaults" action.</p> <h3>Grammar (v2, abridged)</h3> <pre class="overflow-x-auto rounded-lg border bg-muted p-4 text-sm"><code></code></pre> <h3>How a URL is processed</h3> <ol><li><strong>Tokenize</strong> (<code>parseQuery</code>): split on raw <code>&amp;</code>/<code>=</code>, percent-decode each component, and build the AST. Pure syntax — no defaults or
...
Expected an energy unit such as keV, MeV, or MeV/u.</code></pre> <p>Fatal errors (an unreadable link) block the calculation and offer "load defaults"; warnings
      ...
      dropped silently.</p> <p class="text-sm text-muted-foreground">Normative definition (full grammar, semantic rules, conformance vectors): <a href="https://github.com/APTG/dedx_web/blob/master/docs/04-feature-specs/shareable-urls-formal.md" target="_blank" rel="noreferrer" class="underline hover:no-underline">shareable-urls-formal.md</a>.</p></section> <section class="prose max-w-none"><h2>Coming soon</h2> <ul><li>Architecture overview and component tree</li> <li>WASM module build pipeline</li> <li>TypeScript API contract</li> <li>State management with Svelte 5 runes</li> <li>JSROOT integration</li> <li>Testing strategy</li></ul></section></div>`);function f(i){var s=d();e(`s4a66o`,e=>{a(()=>{c.title=`Technical Reference - webdedx`})});var u=l(o(s),2),f=l(o(u),6),p=o(f);p.textContent=`query        = [pair *("&" [pair])]
...
digits       = 1*DIGIT`,t(f),n(14),t(u),n(2),t(s),r(i,s)}export{f as component,u as universal};
//# sourceMappingURL=5.2m_3BirW.js.map