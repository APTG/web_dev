import{C as e,Dt as t,F as n,L as r,Mt as i,Ot as a,Z as o,it as s,nt as c,ot as l}from"../chunks/CBpharUH.js";import"../chunks/xihTtKlq.js";import"../chunks/DXt5L12s.js";var u=i({prerender:()=>!0}),d=r(`<div class="space-y-8"><h1 class="text-3xl font-bold">Technical Reference</h1> <section class="prose max-w-none"><h2>Shareable URL contract</h2> <p>Every calculator and plot view is fully described by its query string, so a URL can be copied,
...
Expected an energy unit such as keV, MeV, or MeV/u.</code></pre> <p>Fatal errors (an unreadable link) block the calculation and offer "load defaults"; warnings
      ...
      dropped silently.</p> <p class="text-sm text-muted-foreground">Normative definition (full grammar, semantic rules, conformance vectors): <a href="https://github.com/APTG/dedx_web/blob/master/docs/04-feature-specs/shareable-urls-formal.md" target="_blank" rel="noreferrer" class="underline hover:no-underline">shareable-urls-formal.md</a>.</p></section> <section class="prose max-w-none"><h2>Coming soon</h2> <ul><li>Architecture overview and component tree</li> <li>WASM module build pipeline</li> <li>TypeScript API contract</li> <li>State management with Svelte 5 runes</li> <li>JSROOT integration</li> <li>Testing strategy</li></ul></section></div>`);function f(r){var i=d();e(`s4a66o`,e=>{o(()=>{c.title=`Technical Reference - webdedx`})});var u=l(s(i),2),f=l(s(u),6),p=s(f);p.textContent=`query        = [pair *("&" [pair])]
...
digits       = 1*DIGIT`,a(f),t(14),a(u),t(2),a(i),n(r,i)}export{f as component,u as universal};
//# sourceMappingURL=5.C1toyF2g.js.map